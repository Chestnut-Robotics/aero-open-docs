...
<img src="./hardware_setup_assets/cable_connection.jpg" alt="Complete wiring with Aero PCBs" width="50%" />
...
1. Solder pin headers to the ESP and connect to the TTLinker Mini Board.
   <img src="./hardware_setup_assets/setupimage.png" alt="ESP to TTLinker Mini Board wiring" width="70%" />

2. Connect the regulated 6V 10A power supply.
   <img src="./hardware_setup_assets/powerconnection.png" alt="6V 10A power supply wiring" width="70%" />

3. Verify the final layout looks similar to this.
   <img src="./hardware_setup_assets/finishedsetup.png" alt="Finished wiring layout example 1" width="70%" />
...
<img src="./hardware_setup_assets/finishedsetup2.png" alt="Finished wiring layout example 2" width="70%" />

**OR** it will looks like this, depending on how you soldered it.

<img src="./hardware_setup_assets/finishedsetup3.png" alt="Finished wiring layout example 3" width="70%" />

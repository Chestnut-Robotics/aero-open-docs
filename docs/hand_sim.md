...
This work builds upon [**MuJoCo Playground**](https://github.com/google-deepmind/mujoco_playground/) as an educational example.  We are actively working on merging [**our implementation**](https://github.com/TetherIA/mujoco_playground_pr) into the official repository.
